  ...
  <div>
    ...
    <el-table
      ...
      <el-table-column
          ...
          width="100">
        <template slot-scope="scope">
          <el-button @click="changeState(scope.row,true)" type="text" size="small" v-if="!scope.row.isban">设置封禁
          </el-button>
          <el-button @click="changeState(scope.row,false)" type="text" size="small" v-if="scope.row.isban">解除封禁
          </el-button>
        </template>
      </el-table-column>
    </el-table>
